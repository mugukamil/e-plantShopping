            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((plant, idx) => (
                        <>
                            <h3 className="plant_heading">{plant.category}</h3>
                                ...
                                {plant.plants.map((plant, idx) => (
                                    <div className="product-card" key={idx}>
                                        ...
                                        <div className="product-info">
                                            ...
                                            {console.log(
                                                CartItems.find((c) => c.name === plant.name),
                                            )}
                                            <button
                                                className={`product-button ${CartItems.find((c) => c.name === plant.name) ? "added-to-cart" : ""}`}
